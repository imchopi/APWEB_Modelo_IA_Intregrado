...
st.markdown("<h3>Responda las siguientes preguntas para predecir su personalidad.</h2>", unsafe_allow_html=True)
...
if st.button("Predecir personalidad"):
    ...
    st.success(f"Su personalidad se clasifica como: {category_mapping[str(prediction)]}", icon="✅")
    st.balloons()
